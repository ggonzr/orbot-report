        ...
        <div class="col-12 col-md-10 offset-md-1 col-xl-8 offset-md-2">
          <card class="content">
            ...
            <p>
              ...
              ejecutar un cambio de identidad con el ánimo de encubrir la retransmisión de paquetes. Esta acción dispara
            ...
            />
            <p>
              Por otro lado, el comando para ejecutarse atravieza diferentes capas en la 
              ...
              Este en su implementación utiliza las caracteristica de <b>OrbotVpnManager</b> clase la cual invoca directamente a la libreria nativa 
