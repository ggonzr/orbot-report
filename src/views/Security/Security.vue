        ...
        <div class="col-12 col-md-10 offset-md-1 col-xl-8 offset-md-2">
          <card class="content">
            ...
            <p>
              ...
              de paquetes. Esta acción dispara el código de acción
            ...
            <p>
              Por otro lado, el comando para ejecutarse atravieza diferentes
              ...
              implementación utiliza las caracteristica de
